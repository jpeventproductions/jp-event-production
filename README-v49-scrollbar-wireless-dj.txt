JP Event Production v49

Updates:
- Added stable always-visible helper scrollbars under the horizontal quote chooser rows.
- Wireless-mic-only quotes now ignore venue size, indoor/outdoor, and speaker-system fields.
